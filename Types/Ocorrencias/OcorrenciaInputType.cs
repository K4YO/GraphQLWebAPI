...
{
    public class OcorrenciaInputType : InputObjectType<OcorrenciaInput>
    {
        protected override void Configure(IInputObjectTypeDescriptor<OcorrenciaInput> descriptor)
        {
