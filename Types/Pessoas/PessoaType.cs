...
{
    public class PessoaType : ObjectType<Pessoa>
    {
        protected override void Configure(IObjectTypeDescriptor<Pessoa> descriptor)
        {
            //Name = "pessoa";
            ...
            descriptor
                ...
                .ResolveWith<Resolver>(p => p.GetOcorrencia(default!, default!))
                .UseDbContext<DbPrfContext>()
                .Description("Ocorrência relacionada a essa Pessoa");
        }
    }
}
